jQuery(document).ready(function ($) {
    ...
    const closeBoxBtn = document.querySelectorAll(".close-mesage");
    const chatBox = document.querySelectorAll(".chat-box");
    // console.log(chatBox);
    for (let i = 0; i < chatBoxBtn.length; i++) {
        chatBoxBtn[i].onclick = function () {
            chatBox[i].classList.add("show");
        };
    }

    for (let i = 0; i < chatBoxBtn.length; i++) {
        closeBoxBtn[i].onclick = function () {
            chatBox[i].classList.remove("show");
        };
    }
...
*/
    ...
    let commentBox = document.querySelectorAll(".post-comt textarea");
    // console.log(commentBox);
    for (let i = 0; i < commentBtn.length; i++) {
        commentBox[i].onkeydown = function (event) {
            if (event.keyCode === 13) {
                commentBtn[i].click();
                jQuery(this).val("");
            }
    ...
    let replytBtn = document.querySelectorAll(".reply-button");
    let replyBox = document.querySelectorAll(".comt-reply textarea");
    for (let i = 0; i < replytBtn.length; i++) {
        replyBox[i].onkeydown = function (event) {
            if (event.keyCode === 13) {
                replytBtn[i].click();
                jQuery(this).val("");
            }
    ...
    let messageButtonR = document.querySelectorAll(".messenger-button-right");
    let messageBoxR = document.querySelectorAll(".text-box textarea");
    for (let i = 0; i < messageButtonR.length; i++) {
        messageBoxR[i].onkeydown = function (event) {
            if (event.keyCode === 13) {
                messageButtonR[i].click();
                jQuery(this).val("");
            }
        };
    }
